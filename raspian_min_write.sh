...
# Originally from RaspAP project, and all credit to them: https://github.com/RaspAP/raspap-tools/blob/main/raspian_min_write.sh
# Run this to greatly reduce writes to flash. Makes logs volatile, so be aware that logs aren't saved between reboots.
